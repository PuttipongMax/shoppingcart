      ...
      <div class="col-3 mb-3">
       <div class="card" style="width: 18rem;">
         <?php if(!empty($product['profile_image'])): ?>
          ...
          />
         <?php else: ?>
          <i class="fa-solid fa-image card-img-top" 
           alt="Product Image"
           style="font-size: 100px"></i>
         <?php endif; ?>
        <div class="card-body">
         <h5 class="card-title"><?php echo $product['product_name']; ?></h5>
         <p class="card-tex text-success fw-bold mb-0"><?php echo number_format($product['price'], 2); ?> Bath</p>
         <p class="card-tex text-muted"><?php echo nl2br($product['detail']); ?></p>
         <a href="<?php echo $base_url; ?>/cart-add.php?id=<?php echo $product['id']; ?>" class="btn btn-primary w-100">
          <i class="fa-solid fa-cart-plus me-1"></i> Add Card
         </a>
        </div>
       </div>
      </div> 
